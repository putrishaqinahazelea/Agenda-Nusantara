...
import 'database_helper.dart'; // Import database helper untuk menyimpan tugas ke SQLite

// Halaman tambah tugas penting
// Pakai StatefulWidget karena tanggal dan input bisa berubah
...
// Tempat isi dan logika halaman tambah tugas penting
class _AddImportantTaskPageState extends State<AddImportantTaskPage> {
  ...
  // Object database helper untuk akses SQLite
  ...
  Future<void> _selectDate(BuildContext context) async {
    ...
    final DateTime? picked = await showDatePicker(
      ...
      // Mengatur warna date picker
      builder: (context, child) {
        return Theme(
          data: Theme.of(context).copyWith(
            colorScheme: const ColorScheme.light(
              primary: Color(0xFFC62828), // Red color for picker
  ...
  void _saveTask() async {
    ...
    // Menyimpan tugas ke database SQLite
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                // Saat diklik, jalankan fungsi simpan
                onPressed: _saveTask,
